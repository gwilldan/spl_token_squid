module.exports = class Data1747534206552 {
    name = 'Data1747534206552'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "token" text NOT NULL, "amount" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "slot" integer NOT NULL, "block_number" integer NOT NULL, "signature" text NOT NULL, "from_id" character varying, "to_id" character varying, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
